...
const ConversationList: React.FC<Props> = ({
  ...
  <div
    className={`${
      collapsed ? "w-16" : "w-72"
    } bg-gray-900/90 backdrop-blur-md border-r border-gray-700/50 flex flex-col transition-all duration-300 shadow-sm`}
  >
    {/* Collapse Toggle */}
    <button
      onClick={onToggleCollapse}
      className="p-3 border-b border-gray-700/50 hover:bg-gray-800/50 flex justify-center transition-colors duration-200"
    >
